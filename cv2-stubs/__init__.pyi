...
class AsyncArray:
    ...
    @_typing.overload
    def get(
        self, dst: cv2.typing.MatLike | None = ...
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    ...
    @_typing.overload
    def get(
        self, timeoutNs: float, dst: UMat | None = ...
    ) -> tuple[bool, UMat]: ...
...
class FileStorage:
    ...
    @_typing.overload
    def __init__(
        self, filename: str, flags: int, encoding: str = ...
    ) -> None: ...
    ...
    def startWriteStruct(
        self, name: str, flags: int, typeName: str = ...
    ) -> None: ...
...
class DMatch:
    ...
    @_typing.overload
    def __init__(
        self, _queryIdx: int, _trainIdx: int, _distance: float
    ) -> None: ...
    @_typing.overload
    def __init__(
...
class UMat:
    ...
    @_typing.overload
    def __init__(
        self, m: UMat, ranges: _typing.Sequence[cv2.typing.Range]
    ) -> None: ...
    @staticmethod
...
class GeneralizedHough(Algorithm):
    ...
    @_typing.overload
    def setTemplate(
        self, templ: UMat, templCenter: cv2.typing.Point = ...
    ) -> None: ...
    @_typing.overload
    def setTemplate(
        self,
...
class MergeMertens(MergeExposures):
    ...
    @_typing.overload
    def process(
        self, src: _typing.Sequence[UMat], dst: UMat | None = ...
    ) -> UMat: ...
...
class DescriptorMatcher(Algorithm):
    ...
    @_typing.overload
    def add(
        self, descriptors: _typing.Sequence[cv2.typing.MatLike]
    ) -> None: ...
    @_typing.overload
...
class BFMatcher(DescriptorMatcher):
    # Functions
    def __init__(
        self, normType: int = ..., crossCheck: bool = ...
    ) -> None: ...
    @classmethod
    def create(
        cls, normType: int = ..., crossCheck: bool = ...
    ) -> BFMatcher: ...
...
class BOWTrainer:
    ...
    @_typing.overload
    def cluster(
        self, descriptors: cv2.typing.MatLike
    ) -> cv2.typing.MatLike: ...
...
class BOWImgDescriptorExtractor:
    # Functions
    def __init__(
        self, dextractor: Feature2D, dmatcher: DescriptorMatcher
    ) -> None: ...
...
class StereoBM(StereoMatcher):
    ...
    @classmethod
    def create(
        cls, numDisparities: int = ..., blockSize: int = ...
    ) -> StereoBM: ...
...
class HOGDescriptor:
    ...
    def detect(
        ...
        _typing.Sequence[cv2.typing.Point], _typing.Sequence[float]
    ]: ...
    @_typing.overload
    def detect(
        self,
...
class QRCodeEncoder:
    ...
    @classmethod
    def create(
        cls, parameters: QRCodeEncoder.Params = ...
    ) -> QRCodeEncoder: ...
    @_typing.overload
    def encode(
...
class GraphicalCodeDetector:
    ...
    def decodeMulti(
        ...
        bool, _typing.Sequence[str], _typing.Sequence[cv2.typing.MatLike]
    ]: ...
    @_typing.overload
    def decodeMulti(
        self,
...
class FaceDetectorYN:
    ...
    @_typing.overload
    def detect(
        self, image: UMat, faces: UMat | None = ...
    ) -> tuple[int, UMat]: ...
    @classmethod
    @_typing.overload
    def create(
...
class FaceRecognizerSF:
    ...
    @_typing.overload
    def feature(
        self, aligned_img: UMat, face_feature: UMat | None = ...
    ) -> UMat: ...
    @_typing.overload
    def match(
        self,
...
class Stitcher:
    ...
    def setInterpolationFlags(
        self, interp_flags: InterpolationFlags
    ) -> None: ...
    @_typing.overload
...
class BackgroundSubtractor(Algorithm):
    ...
    @_typing.overload
    def getBackgroundImage(
        self, backgroundImage: UMat | None = ...
    ) -> UMat: ...
...
class KalmanFilter:
    ...
    def correct(
        self, measurement: cv2.typing.MatLike
    ) -> cv2.typing.MatLike: ...
...
class Tracker:
    ...
    @_typing.overload
    def init(
        self, image: cv2.typing.MatLike, boundingBox: cv2.typing.Rect
    ) -> None: ...
    @_typing.overload
...
class TrackerGOTURN(Tracker):
    ...
    @classmethod
    def create(
        cls, parameters: TrackerGOTURN.Params = ...
    ) -> TrackerGOTURN: ...
...
class TrackerDaSiamRPN(Tracker):
    ...
    @classmethod
    def create(
        cls, parameters: TrackerDaSiamRPN.Params = ...
    ) -> TrackerDaSiamRPN: ...
...
class GMatDesc:
    ...
    @_typing.overload
    def __init__(
        self, d: int, c: int, s: cv2.typing.Size, p: bool = ...
    ) -> None: ...
    @_typing.overload
...
class GStreamingCompiled:
    ...
    def pull(
        ...
        bool,
        _typing.Sequence[cv2.typing.GRunArg]
        | _typing.Sequence[cv2.typing.GOptRunArg],
    ]: ...
    def stop(self) -> None: ...
...
@_typing.overload
def accumulateSquare(
    src: UMat, dst: UMat, mask: UMat | None = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def applyColorMap(
    src: UMat, colormap: int, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def applyColorMap(
    src: cv2.typing.MatLike,
...
@_typing.overload
def applyColorMap(
    src: UMat, userColor: UMat, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def approxPolyDP(
...
@_typing.overload
def bitwise_not(
    src: UMat, dst: UMat | None = ..., mask: UMat | None = ...
) -> UMat: ...
@_typing.overload
def bitwise_or(
    src1: cv2.typing.MatLike,
...
@_typing.overload
def boxPoints(
    box: cv2.typing.RotatedRect, points: UMat | None = ...
) -> UMat: ...
@_typing.overload
def broadcast(
    src: cv2.typing.MatLike,
...
def calibrateCamera(
    ...
    float, UMat, UMat, _typing.Sequence[UMat], _typing.Sequence[UMat]
]: ...
@_typing.overload
...
def calibrateCameraRO(
    ...
    float, UMat, UMat, _typing.Sequence[UMat], _typing.Sequence[UMat], UMat
]: ...
@_typing.overload
...
@_typing.overload
def checkChessboard(
    img: cv2.typing.MatLike, size: cv2.typing.Size
) -> bool: ...
@_typing.overload
...
@_typing.overload
def compare(
    src1: UMat, src2: UMat, cmpop: int, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def compareHist(
...
def connectedComponentsWithStats(
    ...
    int, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike
]: ...
@_typing.overload
def connectedComponentsWithStats(
    image: UMat,
...
@_typing.overload
def contourArea(
    contour: cv2.typing.MatLike, oriented: bool = ...
) -> float: ...
@_typing.overload
...
@_typing.overload
def cvtColorTwoPlane(
    src1: UMat, src2: UMat, code: int, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def dct(
    src: cv2.typing.MatLike,
...
def dilate(
    src: cv2.typing.MatLike,
    kernel: cv2.typing.MatLike | None,
    dst: cv2.typing.MatLike | None = ...,
    anchor: cv2.typing.Point = ...,
    iterations: int = ...,
    borderType: int = ...,
...
@_typing.overload
def imwrite(
    filename: str, img: UMat, params: _typing.Sequence[int] = ...
) -> bool: ...
@_typing.overload
def imwritemulti(
    filename: str,
...
@_typing.overload
def inRange(
    src: UMat, lowerb: UMat, upperb: UMat, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def inRange(
    src: cv2.typing.MatLike,
...
@_typing.overload
def merge(
    mv: _typing.Sequence[cv2.typing.MatLike],
    dst: cv2.typing.MatLike | None = ...,
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def norm(
    src1: UMat, normType: int = ..., mask: UMat | None = ...
) -> float: ...
@_typing.overload
def norm(
    src1: cv2.typing.MatLike,
...
@_typing.overload
def patchNaNs(
    a: cv2.typing.MatLike, val: float = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
def rectangleIntersectionArea(
    a: cv2.typing.Rect2d, b: cv2.typing.Rect2d
) -> float: ...
@_typing.overload
...
@_typing.overload
def scaleAdd(
    src1: UMat, alpha: float, src2: UMat, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def seamlessClone(
    src: cv2.typing.MatLike,
...
def setWindowProperty(
    winname: str, prop_id: int, prop_value: float
) -> None: ...
...
@_typing.overload
def solveLP(
    Func: UMat, Constr: UMat, z: UMat | None = ...
) -> tuple[int, UMat]: ...
@_typing.overload
def solveP3P(
    objectPoints: cv2.typing.MatLike,
...
def solvePnPRansac(
    ...
    bool, cv2.typing.MatLike, cv2.typing.MatLike, cv2.typing.MatLike
]: ...
@_typing.overload
def solvePnPRansac(
    objectPoints: UMat,
...
def split(
    m: cv2.typing.MatLike,
    mv: _typing.Sequence[cv2.typing.MatLike] | None = ...,
) -> _typing.Sequence[cv2.typing.MatLike]: ...
@_typing.overload
def split(
...
@_typing.overload
def stackBlur(
    src: UMat, ksize: cv2.typing.Size, dst: UMat | None = ...
) -> UMat: ...
